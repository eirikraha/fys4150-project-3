...
\centering
\begin{subfigure}{0.32\textwidth}
	\includegraphics[scale=0.25]{{../figures/ES/ES_Verlet_dt1.0e-01_vy6.28}.png}
	\caption{dt = 1.0e-01}
	\label{fig:verletdt1.0e-01}
\end{subfigure}
\begin{subfigure}{0.33\textwidth}
...
\end{subfigure}
\caption{Simulation of the Earth-Sun system using Velocity Verlet with different time steps. The initial velocity is in all cases set to 6.28 AU/years, the Sun is fixed in origo and the Earth starts in (1, 0, 0) AU}
\label{fig:ES-Verlet}
\end{figure}

Analytically we found that the escape velocity was 8.82 AU/years. Some of our trial and errors are shown in figure \husk{ref!}
\subsubsection*{The Earth-Sun-Jupiter system}
...
\end{subfigure}
\caption{Simulation of the Earth-Sun-Jupiter system using Velocity Verlet with different time steps. Initial velocity and position for the Earth and Jupiter is retrieved from NASA and the Sun is fixed to Origo.}
\label{fig:ESJ1}
\end{figure}
...
\end{subfigure}
\caption{Simulation of the Earth-Sun-Jupiter system using Velocity Verlet with different time steps. Initial velocity and position for the Earth, the Sun and Jupiter is retrieved from NASA and the center-of-mass is in origo.}
\label{fig:ESJ2}
\end{figure}
...
\label{fig:ESJm1000}
\end{subfigure}
\caption{Simulation of the Earth-Sun-Jupiter system using Velocity Verlet with different mass of Jupiter. Initial velocity and position for the Earth and Jupiter is retrieved from NASA and the Sun is fixed to Origo.}
\label{fig:ESJ1Crash}
\end{figure}
\subsubsection*{The whole Solar System}
