...
\end{subfigure}
\caption{Simulation using forward Euler with different time steps. The initial velocity is in all cases set to 6.28 AU/years, the Sun is fixed in origo and the Earth starts in (1, 0, 0) AU}
\label{ES-Euler}
\end{figure}
\subsubsection*{The Earth-Sun-Jupiter system}
\subsubsection*{The whole Solar System}
